        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          {sent ? (
            <div className="text-center">
              ...
              <Link href="/admin/login" className="btn-primary btn-sm">Back to Login</Link>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-caption text-neutral-400 text-center">
                ...
                <Link href="/admin/login" className="text-primary-500 hover:underline font-semibold">Sign in</Link>
              </p>
            </form>
          )}
        </div>
