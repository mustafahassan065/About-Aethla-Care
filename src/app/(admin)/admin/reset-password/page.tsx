        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          {success ? (
            <div className="text-center">
              ...
              <Link href="/admin/login" className="btn-primary btn-sm">Go to Login</Link>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {!token && (
                <div className="bg-red-50 border border-red-200 rounded-xl px-4 py-3">
                  <p className="text-body-sm text-red-600">Invalid reset link. Please <Link href="/admin/forgot-password" className="underline">request a new one</Link>.</p>
                </div>
              )}
              ...
              <p className="text-caption text-neutral-400 text-center">
                <Link href="/admin/login" className="text-primary-500 hover:underline font-semibold">Back to Login</Link>
              </p>
            </form>
          )}
        </div>
