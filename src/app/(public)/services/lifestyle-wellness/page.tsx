...
export default function ServicePage() {
  ...
  const whoItems = [{'title': 'Healthy Ageing', 'desc': 'Programs to help older adults maintain mobility, independence and quality of life.'}, {'title': 'Disease Prevention', 'desc': 'Personalised strategies to reduce the risk of chronic diseases before they develop.'}, {'title': 'Active Living', 'desc': 'Exercise and mobility coaching to keep clients physically active at home.'}, {'title': 'Nutritional Planning', 'desc': 'Customised diet and nutrition plans developed by qualified health professionals.'}, {'title': 'Mental Wellbeing', 'desc': 'Emotional wellness support and stress management coaching delivered at home.'}, {'title': 'Lifestyle Coaching', 'desc': 'Habit-building programs to support sustained, positive lifestyle changes.'}]
