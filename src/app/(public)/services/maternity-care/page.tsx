    ...
    <>
      ...
      <section className="relative min-h-[480px] flex items-end pb-16 overflow-hidden">
        ...
        <div className="container-max px-4 md:px-8 relative z-10">
          ...
          <h1 className="text-display-lg text-white mb-3">Maternity Care in Qatar</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="rounded-3xl overflow-hidden shadow-xl h-[460px]">
                <img
                  src="https://images.unsplash.com/photo-1492725764893-90b379c2b6e7?w=800&q=80&auto=format&fit=crop"
                  alt="Maternity Care at home"
                  className="w-full h-full object-cover"
                />
              </div>
      ...
      <section className="section-pad" style={{ background: 'var(--color-bg-soft)' }}>
        <div className="container-max">
          <div className="section-header">
            ...
            <h2 className="text-display-sm mb-4">Why Choose Aethla Care for Maternity Care</h2>
          </div>
