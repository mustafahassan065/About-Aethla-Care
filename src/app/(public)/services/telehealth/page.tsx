    ...
    <>
      ...
      <section className="relative min-h-[480px] flex items-end pb-16 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <img
            src="https://images.unsplash.com/photo-1587614382346-4ec70e388b28?w=1920&q=80&auto=format&fit=crop"
        ...
        <div className="container-max px-4 md:px-8 relative z-10">
          ...
          <h1 className="text-display-lg text-white mb-3">Telehealth Support in Qatar</h1>
            ...
            <div className="relative">
              <div className="rounded-3xl overflow-hidden shadow-xl h-[460px]">
                <img
                  ...
                  alt="Telehealth Support at home"
                  className="w-full h-full object-cover"
                />
              </div>
      ...
      <section className="section-pad" style={{ background: 'var(--color-bg-soft)' }}>
        <div className="container-max">
          <div className="section-header">
            ...
            <h2 className="text-display-sm mb-4">Why Choose Aethla Care for Telehealth Support</h2>
          </div>
