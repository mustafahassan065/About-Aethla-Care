...
export const metadata: Metadata = {
  title: 'Patient Navigation Qatar | Aethla Care',
  description: 'Professional patient navigation services at home in Qatar — compassionate, qualified care tailored to your family needs.',
}

export default function ServicePage() {
  const features = ['Insurance claim assistance', 'Hospital and specialist referrals', 'PHCC coordination and bookings', 'Medical records management', 'Appointment scheduling and reminders', 'Care transition support', 'Interpretation and translation support', 'Family guidance through healthcare systems']
  const whoItems = [{'title': 'Insurance Claims', 'desc': 'Expert guidance navigating insurance processes and claim submissions in Qatar.'}, {'title': 'Hospital Referrals', 'desc': 'Coordination of specialist referrals and hospital appointments on your behalf.'}, {'title': 'PHCC Coordination', 'desc': "Booking and coordination with Qatar's Primary Health Care Corporation network."}, {'title': 'Medical Interpretation', 'desc': 'Translation and interpretation support for medical consultations and records.'}, {'title': 'Care Transition Support', 'desc': 'Support transitioning between hospital, rehabilitation, and home care settings.'}, {'title': 'Medical Records Management', 'desc': 'Organised management and access to all medical records and documentation.'}]
    ...
    <>
      ...
      <section className="bg-section-gradient py-28 px-4 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="trust-pill inline-flex mb-5 justify-center">
            <span className="w-2 h-2 rounded-full bg-accent-400" /> Patient Navigation
          </div>
          <h1 className="text-display-lg text-white mb-4">Patient Navigation in Qatar</h1>
          <p className="text-body-lg text-white/75 max-w-2xl mx-auto">
            Professional patient navigation services delivered at home across Qatar — compassionate, qualified care tailored to each family.
          </p>
        </div>
      </section>
        ...
        <div className="container-max">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="h-[420px] rounded-3xl overflow-hidden shadow-lg">
              <img
                src="/images/Patient Navigation & Education/Healthcare System Navigation.png"
                alt="Patient Navigation Qatar"
                className="w-full h-full object-cover"
              />
            </div>
            <div>
              <div className="section-label mb-3">About This Service</div>
              <h2 className="text-display-sm mb-5">Professional Patient Navigation</h2>
              <p className="text-body-md text-neutral-600 leading-relaxed mb-4">
                Aethla Care provides qualified professionals who deliver expert patient navigation directly in the comfort of your home.
        ...
        <div className="container-max">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="h-[520px] rounded-3xl overflow-hidden shadow-lg">
              <img
                src="/images/Patient Navigation & Education/Insurance Guidance.png"
                alt="Patient Navigation at home Qatar"
                className="w-full h-full object-cover"
              />
            </div>
          </div>
      ...
      <section className="section-pad bg-white">
        <div className="container-max">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="h-[420px] rounded-3xl overflow-hidden shadow-lg">
              <img
                src="/images/Patient Navigation & Education/Medical Information Interpretation.png"
                alt="Patient Navigation Aethla Care Qatar"
                className="w-full h-full object-cover"
              />
            </div>
            <div>
      ...
      <section className="section-pad bg-section-gradient text-center">
        <div className="container-max max-w-2xl">
          <h2 className="text-display-sm text-white mb-4">Arrange Patient Navigation at Home</h2>
