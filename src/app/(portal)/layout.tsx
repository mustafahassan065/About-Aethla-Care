  ...
  return (
    <>
      ...
      <aside
        ...
        style={{ width: '260px', background: '#1A4A35' }}
      >
        <div className="flex items-center justify-between px-5 py-5 border-b border-white/10">
          <Link href="/portal/dashboard" className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl flex items-center justify-center text-white font-bold font-poppins text-base"
              style={{ background: 'linear-gradient(135deg, #2DA88A, #1B6B8A)' }}>A</div>
            <div>
              <span className="block text-sm font-extrabold font-poppins text-white leading-tight">Aethla Care</span>
              <span className="block text-[10px] text-white/40 uppercase tracking-widest">Family Portal</span>
            </div>
          </Link>
        ...
        <div className="p-3 border-t border-white/10">
          <div className="flex items-center gap-3 p-3 rounded-xl" style={{ background: 'rgba(255,255,255,0.06)' }}>
            <div className="w-9 h-9 rounded-full flex items-center justify-center text-white font-bold font-poppins text-sm flex-shrink-0"
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[11px] text-white/40 truncate">Family Member</p>
            </div>
...
export default function CustomerLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <AdminGuard allowedRoles={['family', 'client']} redirectTo="/portal/login">
