    ...
    <div className="min-h-screen flex items-center justify-center px-4"
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold font-poppins text-white mb-1">Family Portal</h1>
          <p className="text-white/55 text-body-sm">Aethla Care · Secure Family Access</p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={isLoading} className="btn-primary btn-lg w-full mt-2">
              {isLoading ? 'Signing in...' : 'Access Family Portal'}
            </button>
          </form>
